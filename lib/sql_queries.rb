...
"SELECT projects.category, SUM(pledges.amount) FROM projects INNER JOIN pledges ON projects.id == pledges.project_id GROUP BY projects.category HAVING projects.category LIKE 'books'"
end
